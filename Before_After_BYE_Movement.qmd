...
#total_distance_PRE <- bind_rows(total_distanceCLE4, total_distanceLAC4)
#total_distance_POST <- bind_rows(total_distanceCLE6, total_distanceLAC6)
...
#total_distance_PRE <- bind_rows(total_distance_PRE, total_distanceSEA4)
#total_distance_POST <- bind_rows(total_distance_POST, total_distanceSEA6)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceTB4)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceTB6)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceGB5)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceGB7)
...
print(PIT_Combined)
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distancePIT5)
#total_distance_POST <- bind_cols(total_distance_POST, total_distancePIT7)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceCAR6)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceCAR8)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceCIN6)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceCIN8)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceDAL6)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceDAL8)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceHOU6)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceHOU8)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceNYJ6)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceNYJ8)
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceTEN6)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceTEN8)

print(ggplot(TEN_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceDB8)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceDB10)

print(ggplot(DB_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceDL8)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceDL10)

print(ggplot(DL_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceJAX8)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceJAX10)

print(ggplot(JAX_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceSF8)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceSF10)

print(ggplot(SF_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceKC9)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceKC11)

print(ggplot(KC_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceLAR9)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceLAR11)

print(ggplot(LAR_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceMIA9)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceMIA11)

print(ggplot(MIA_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distancePHI9)
#total_distance_POST <- bind_cols(total_distance_POST, total_distancePHI11)

print(ggplot(PHI_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceATL10)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceATL12)

print(ggplot(ATL_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceIND10)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceIND12)

print(ggplot(IND_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceNE10)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceNE12)

print(ggplot(NE_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceNO10)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceNO12)

print(ggplot(NO_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceBAL12)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceBAL14)

print(ggplot(BAL_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceBUF12)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceBUF14)

print(ggplot(BUF_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceCHI12)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceCHI14)

print(ggplot(CHI_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceLAV12)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceLAV14)

print(ggplot(LAV_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceMIN12)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceMIN14)

print(ggplot(MIN_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceNYG12)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceNYG14)

print(ggplot(NYG_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceARI13)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceARI15)

print(ggplot(ARI_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
#total_distance_PRE <- bind_cols(total_distance_PRE, total_distanceWAS13)
#total_distance_POST <- bind_cols(total_distance_POST, total_distanceWAS15)

print(ggplot(WAS_Combined, aes(x = total_distance, fill = group)) +
  geom_density(alpha = 0.6, color = NA) +
  labs(
    title = "Distribution of Player Distances by Team",
    x = "Distance (yards)",
...
```{R}
total_distance_POST[is.na(total_distance_POST$BYE_WEEK), ]
```
...
ggplot(ALL_BYE, aes(x = BYE_WEEK, y = total_distance, color = group)) + geom_point(size = 3) + theme_minimal() + scale_x_continuous(breaks = pretty_breaks())+
  labs(
  title = "Pre- vs. Post-Bye Average Distance by Bye Week ",
  x = 'Bye Week',
  y = "Avg. Dist. of Player's Movement Per Play Over Entire Game"
)
```
...
library(dplyr)
library(scales)
scores <- read.csv("data/train/2023NFLSCORES.csv")
scores <- scores %>%
  rename(
    Home_Team = X.1,
    Away_Team = X.2,
...
games <- games %>%
  mutate(
    ...
    tz_diff = home_offset - away_offset,
    point_diff = Away_Score - Home_Score,
  )

ggplot(games, aes(x = tz_diff, y = point_diff)) + geom_point(size = 3) + theme_minimal() + scale_x_continuous(breaks = pretty_breaks())
```
...
Another aspect of the schedule we were interested in was how travel affected the performance of teams. In order to look at this, we plotted the point differential of the away team and the home team to the time zone difference the away team faced. When we plotted a line, we saw that it was flat with almost no slope. This shows that home teams traveling farther for their matches do not necessarily do worse. We shouldn't be worried that the Eagles have a game in Tampa any more than if they have one in San Francisco. Though the line didn't have much slope, what was interesting to discover was that it did have a negative intercept. A negative intercept for a point differential at an away game means that on average away teams in 2023 performed worse than home teams.

This is interesting since the hosting the game is generally thought of as an advantage to the home team and teams do on average have a higher win percentage at home. What this is then suggesting is that when blow out games occur, the away team is more often the team to be the winner. And within the graph we can see that to be the case. From the graph, we can see that there were 6 games where the away team lost by 25 or more points. We can compare that with home teams that lost at least 15, one of which was by 50 points.

```{r}
ggplot(games, aes(x = tz_diff, y = point_diff)) + geom_point(size = 3) + stat_smooth(method = 'lm', formula = y ~exp(x), se = FALSE, color = 'red') + theme_minimal() +
  scale_x_continuous(breaks = pretty_breaks()) + labs(
    x = 'Away Team Time Zone Difference',
    y = 'Away Team Game Point Differential'
  )
...
ggplot(far_away, aes(x = tz_diff, y = point_diff)) + geom_point(size = 3) + stat_smooth(method = 'lm', formula = y ~exp(x), se = FALSE, color = 'red') + theme_minimal() +
  scale_x_continuous(breaks = pretty_breaks()) + labs(
    x = 'Away Team Time Zone Difference',
    y = 'Away Team Game Point Differential'
  )
